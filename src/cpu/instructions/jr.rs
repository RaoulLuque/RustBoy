...
impl CPU {
    ...
    pub fn handle_jr_instruction(
        ...
        self.jr(memory_bus, should_jump)
    }
    ...
    fn jr(&mut self, memory_bus: &MemoryBus, should_jump: bool) -> u16 {
        if should_jump {
            ...
            let relative_jump = (memory_bus.read_byte(self.pc.wrapping_add(1)) as i8) as i16;
