...
|----|---------------|---------------|----------------|---------------|-----------------|---------------|----------------|---------------|-----------------|---------------|----------------|-------------|----------------|--------------|----------------|-------------|
| 0x | [ ] NOP       | [x] LD BC,d16 | [x] LD (BC),A  | [x] INC BC    | [x] INC B       | [x] DEC B     | [x] LD B,d8    | [ ] RLCA      | [x] LD (a16),SP | [ ] ADD HL,BC | [x] LD A,(BC)  | [x] DEC BC  | [x] INC C      | [x] DEC C    | [x] LD C,d8    | [ ] RRCA    |
| 1x | [ ] STOP 0    | [x] LD DE,d16 | [x] LD (DE),A  | [x] INC DE    | [x] INC D       | [x] DEC D     | [x] LD D,d8    | [ ] RLA       | [ ] JR r8       | [ ] ADD HL,DE | [x] LD A,(DE)  | [x] DEC DE  | [x] INC E      | [x] DEC E    | [x] LD E,d8    | [ ] RRA     |
| 2x | [ ] JR NZ,r8  | [x] LD HL,d16 | [x] LD (HL+),A | [x] INC HL    | [x] INC H       | [x] DEC H     | [x] LD H,d8    | [ ] DAA       | [ ] JR Z,r8     | [ ] ADD HL,HL | [x] LD A,(HL+) | [x] DEC HL  | [x] INC L      | [x] DEC L    | [x] LD L,d8    | [ ] CPL     |
| 3x | [ ] JR NC,r8  | [x] LD SP,d16 | [x] LD (HL-),A | [x] INC SP    | [x] INC (HL)    | [x] DEC (HL)  | [x] LD (HL),d8 | [ ] SCF       | [ ] JR C,r8     | [ ] ADD HL,SP | [x] LD A,(HL-) | [x] DEC SP  | [x] INC A      | [x] DEC A    | [x] LD A,d8    | [ ] CCF     |
...
| Cx | [x] RET NZ    | [x] POP BC    | [x] JP NZ,a16  | [x] JP a16    | [x] CALL NZ,a16 | [x] PUSH BC   | [x] ADD A,d8   | [ ] RST 00H   | [x] RET Z       | [x] RET       | [x] JP Z,a16   |             | [x] CALL Z,a16 | [x] CALL a16 | [x] ADC A,d8   | [ ] RST 1   |
| Dx | [x] RET NC    | [x] POP DE    | [x] JP NC,a16  |               | [x] CALL NC,a16 | [x] PUSH DE   | [x] SUB A,d8   | [ ] RST 10H   | [x] RET C       | [ ] RETI      | [x] JP C,a16   |             | [x] CALL C,a16 |              | [x] SBC A,d8   | [ ] RST 3   |
| Ex | [ ] LD (a8),A | [x] POP HL    | [ ] LD (C),A   |               |                 | [x] PUSH HL   | [x] AND d8     | [ ] RST 20H   | [ ] ADD SP,r8   | [x] JP (HL)   | [ ] LD (a16),A |             |                |              | [x] XOR d8     | [ ] RST 5   |
| Fx | [ ] LD A,(a8) | [x] POP AF    | [ ] LD A,(C)   | [ ] DI        |                 | [x] PUSH AF   | [x] OR d8      | [ ] RST 30H   | [ ] LD HL,SP+r8 | [ ] LD SP,HL  | [ ] LD A,(a16) | [ ] EI      |                |              | [x] CP d8      | [ ] RST 7   |
```
