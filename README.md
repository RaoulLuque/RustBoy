...
| 2x | [x] JR NZ,r8  | [x] LD HL,d16 | [x] LD (HL+),A | [x] INC HL    | [x] INC H       | [x] DEC H     | [x] LD H,d8    | [ ] DAA       | [x] JR Z,r8     | [ ] ADD HL,HL | [x] LD A,(HL+) | [x] DEC HL  | [x] INC L      | [x] DEC L    | [x] LD L,d8    | [ ] CPL     |
| 3x | [x] JR NC,r8  | [x] LD SP,d16 | [x] LD (HL-),A | [x] INC SP    | [x] INC (HL)    | [x] DEC (HL)  | [x] LD (HL),d8 | [ ] SCF       | [x] JR C,r8     | [ ] ADD HL,SP | [x] LD A,(HL-) | [x] DEC SP  | [x] INC A      | [x] DEC A    | [x] LD A,d8    | [ ] CCF     |
