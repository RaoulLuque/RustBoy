...
|----|----------------|---------------|----------------|---------------|-----------------|---------------|----------------|---------------|-----------------|---------------|----------------|-------------|----------------|--------------|----------------|-------------|
| 0x | [x] NOP        | [x] LD BC,d16 | [x] LD (BC),A  | [x] INC BC    | [x] INC B       | [x] DEC B     | [x] LD B,d8    | [ ] RLCA      | [x] LD (a16),SP | [ ] ADD HL,BC | [x] LD A,(BC)  | [x] DEC BC  | [x] INC C      | [x] DEC C    | [x] LD C,d8    | [ ] RRCA    |
| 1x | [ ] STOP       | [x] LD DE,d16 | [x] LD (DE),A  | [x] INC DE    | [x] INC D       | [x] DEC D     | [x] LD D,d8    | [ ] RLA       | [x] JR r8       | [ ] ADD HL,DE | [x] LD A,(DE)  | [x] DEC DE  | [x] INC E      | [x] DEC E    | [x] LD E,d8    | [ ] RRA     |
| 2x | [x] JR NZ,r8   | [x] LD HL,d16 | [x] LD (HL+),A | [x] INC HL    | [x] INC H       | [x] DEC H     | [x] LD H,d8    | [x] DAA       | [x] JR Z,r8     | [ ] ADD HL,HL | [x] LD A,(HL+) | [x] DEC HL  | [x] INC L      | [x] DEC L    | [x] LD L,d8    | [x] CPL     |
| 3x | [x] JR NC,r8   | [x] LD SP,d16 | [x] LD (HL-),A | [x] INC SP    | [x] INC (HL)    | [x] DEC (HL)  | [x] LD (HL),d8 | [x] SCF       | [x] JR C,r8     | [ ] ADD HL,SP | [x] LD A,(HL-) | [x] DEC SP  | [x] INC A      | [x] DEC A    | [x] LD A,d8    | [x] CCF     |
...
| Ex | [x] LDH (a8),A | [x] POP HL    | [x] LDH (C),A  |               |                 | [x] PUSH HL   | [x] AND d8     | [x] RST 4     | [ ] ADD SP,r8   | [x] JP (HL)   | [ ] LD (a16),A |             |                |              | [x] XOR d8     | [x] RST 5   |
| Fx | [x] LDH A,(a8) | [x] POP AF    | [x] LDH A,(C)  | [ ] DI        |                 | [x] PUSH AF   | [x] OR d8      | [x] RST 6     | [ ] LD HL,SP+r8 | [ ] LD SP,HL  | [ ] LD A,(a16) | [ ] EI      |                |              | [x] CP d8      | [x] RST 7   |
```
