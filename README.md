...
|----|---------------|---------------|----------------|---------------|-----------------|---------------|----------------|---------------|-----------------|---------------|----------------|-------------|----------------|--------------|----------------|-------------|
| 0x | [ ] NOP       | [ ] LD BC,d16 | [ ] LD (BC),A  | [x] INC BC    | [x] INC B       | [x] DEC B     | [ ] LD B,d8    | [ ] RLCA      | [ ] LD (a16),SP | [ ] ADD HL,BC | [ ] LD A,(BC)  | [x] DEC BC  | [x] INC C      | [x] DEC C    | [ ] LD C,d8    | [ ] RRCA    |
| 1x | [ ] STOP 0    | [ ] LD DE,d16 | [ ] LD (DE),A  | [x] INC DE    | [x] INC D       | [x] DEC D     | [ ] LD D,d8    | [ ] RLA       | [ ] JR r8       | [ ] ADD HL,DE | [ ] LD A,(DE)  | [x] DEC DE  | [x] INC E      | [x] DEC E    | [ ] LD E,d8    | [ ] RRA     |
| 2x | [ ] JR NZ,r8  | [ ] LD HL,d16 | [ ] LD (HL+),A | [x] INC HL    | [x] INC H       | [x] DEC H     | [ ] LD H,d8    | [ ] DAA       | [ ] JR Z,r8     | [ ] ADD HL,HL | [ ] LD A,(HL+) | [x] DEC HL  | [x] INC L      | [x] DEC L    | [ ] LD L,d8    | [ ] CPL     |
| 3x | [ ] JR NC,r8  | [ ] LD SP,d16 | [ ] LD (HL-),A | [x] INC SP    | [x] INC (HL)    | [x] DEC (HL)  | [ ] LD (HL),d8 | [ ] SCF       | [ ] JR C,r8     | [ ] ADD HL,SP | [ ] LD A,(HL-) | [x] DEC SP  | [x] INC A      | [x] DEC A    | [ ] LD A,d8    | [ ] CCF     |
