...
|----|---------------|---------------|----------------|---------------|-----------------|---------------|----------------|---------------|-----------------|---------------|----------------|-------------|----------------|--------------|----------------|-------------|
| 0x | [x] NOP       | [x] LD BC,d16 | [x] LD (BC),A  | [ ] INC BC    | [ ] INC B       | [ ] DEC B     | [x] LD B,d8    | [ ] RLCA      | [x] LD (a16),SP | [ ] ADD HL,BC | [x] LD A,(BC)  | [ ] DEC BC  | [ ] INC C      | [ ] DEC C    | [x] LD C,d8    | [ ] RRCA    |
| 1x | [ ] STOP 0    | [x] LD DE,d16 | [x] LD (DE),A  | [ ] INC DE    | [ ] INC D       | [ ] DEC D     | [x] LD D,d8    | [ ] RLA       | [ ] JR r8       | [ ] ADD HL,DE | [x] LD A,(DE)  | [ ] DEC DE  | [ ] INC E      | [ ] DEC E    | [x] LD E,d8    | [ ] RRA     |
| 2x | [ ] JR NZ,r8  | [x] LD HL,d16 | [x] LD (HL+),A | [ ] INC HL    | [ ] INC H       | [ ] DEC H     | [x] LD H,d8    | [ ] DAA       | [ ] JR Z,r8     | [ ] ADD HL,HL | [x] LD A,(HL+) | [ ] DEC HL  | [ ] INC L      | [ ] DEC L    | [x] LD L,d8    | [ ] CPL     |
| 3x | [ ] JR NC,r8  | [x] LD SP,d16 | [x] LD (HL-),A | [ ] INC SP    | [ ] INC (HL)    | [ ] DEC (HL)  | [x] LD (HL),d8 | [ ] SCF       | [ ] JR C,r8     | [ ] ADD HL,SP | [x] LD A,(HL-) | [ ] DEC SP  | [ ] INC A      | [ ] DEC A    | [x] LD A,d8    | [ ] CCF     |
