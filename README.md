...
- [Game Boy Emulation in JavaScript](https://imrannazar.com/series/gameboy-emulation-in-javascript)
...
| 7x | [x] LD (HL),B  | [x] LD (HL),C | [x] LD (HL),D  | [x] LD (HL),E | [x] LD (HL),H   | [x] LD (HL),L | [x] HALT       | [x] LD (HL),A | [x] LD A,B      | [x] LD A,C    | [x] LD A,D     | [x] LD A,E  | [x] LD A,H     | [x] LD A,L   | [x] LD A,(HL)  | [x] LD A,A  |
...
| Dx | [x] RET NC     | [x] POP DE    | [x] JP NC,a16  |               | [x] CALL NC,a16 | [x] PUSH DE   | [x] SUB A,d8   | [x] RST 2     | [x] RET C       | [x] RETI      | [x] JP C,a16   |             | [x] CALL C,a16 |              | [x] SBC A,d8   | [x] RST 3   |
